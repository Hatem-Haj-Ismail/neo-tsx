...
// Typisierung der Navbar-Komponente
const Navbar: React.FC = () => {
  const [menuOpen, setMenuOpen] = useState<boolean>(false); // Typisierung des useState

  useEffect(() => {
    const closeMenu = (e: MouseEvent) => {
      const target = e.target as HTMLElement; // Casten des Target-Objekts zu HTMLElement
  ...
  return (
    <nav className="navbar">
      ...
      <ul className={`navLinks ${menuOpen ? "open" : ""}`}>
        ...
        <li>
          <Link to="/features" data-replace="Features">
            Features
          </Link>
        </li>
        <li>
          <a href="/faq" data-replace="FAQ">
            FAQ
          </a>
        </li>
        <li>
        ...
        <li className="arabic">
          ...
          <a href="#arabic" className="no-line" data-replace="العربية">
            العربية
          </a>
        </li>
        <li>
